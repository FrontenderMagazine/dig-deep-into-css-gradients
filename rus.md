...
Колесо, которое также можно представить назвать обычным кругом, сначала разделяем 
по горизонтали на две части и затем каждую половину еще на 5 частей, так что в 
...
И в исходном примере, и в дополнительномм демо нас интересует эта часть:

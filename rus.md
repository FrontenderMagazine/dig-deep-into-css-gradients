...
градиенты CSS до того, как в конце 2011 года обнаружила [галерею паттернов
CSS3][1] созданную Леа Веру (Lea Verou). Возможность создавать различные
фигуры, используя градиенты, стала отправной точкой для моих собственных
экспериментов с CSS.
...
получаем 20 секторов. [Центральный угол][4] каждого сектора составляет
[360°][5]/10 = 36°.
...
И в проимере и в демо нас интересует одно:
